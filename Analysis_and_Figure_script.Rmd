...
#Figure 3 - top hits from each of the clusters ovearll - supplemental image
dittoHeatmap(object = sc_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F,
            labels_row = as.expression(lapply(c(Dpp4_Heatmap_SC, Icam1_Heatmap_SC, Cd142_Heatmap_SC), function(x) bquote(italic(.(x))))),
             heatmap.colors = HeatmapCols, fontsize_row = 17)


#Young vs Old for the interesting populations -----------------------------------------------------------------------------------------
#Dittoheatmaps
YoungUp <- FindMarkers(sc_Final_iWAT_Analysis@assays$RNA,
                     cells.1 = colnames(sc_Final_iWAT_Analysis)[sc_Final_iWAT_Analysis$Named_clusters == c('Dpp4+ Fibroblasts', 'Icam1+ Preadipocytes','Cd142+ Fibroblasts') &
                                                         sc_Final_iWAT_Analysis$Age == "Young"],
                     cells.2 = colnames(sc_Final_iWAT_Analysis)[sc_Final_iWAT_Analysis$Named_clusters == c('Dpp4+ Fibroblasts', 'Icam1+ Preadipocytes','Cd142+ Fibroblasts') &
                                                         sc_Final_iWAT_Analysis$Age == "Aged"], only.pos = F, logfc.threshold = 0.1) %>% subset(p_val_adj < 0.01) %>% dplyr::arrange(desc(avg_log2FC)) %>% head(15) %>% rownames()

OldUp <- FindMarkers(sc_Final_iWAT_Analysis@assays$RNA,
                     cells.1 = colnames(sc_Final_iWAT_Analysis)[sc_Final_iWAT_Analysis$Named_clusters == c('Dpp4+ Fibroblasts', 'Icam1+ Preadipocytes','Cd142+ Fibroblasts') &
                                                         sc_Final_iWAT_Analysis$Age == "Young"],
                     cells.2 = colnames(sc_Final_iWAT_Analysis)[sc_Final_iWAT_Analysis$Named_clusters == c('Dpp4+ Fibroblasts', 'Icam1+ Preadipocytes','Cd142+ Fibroblasts') &
                                                         sc_Final_iWAT_Analysis$Age == "Aged"], only.pos = F, logfc.threshold = 0.1) %>% subset(p_val_adj < 0.01) %>% dplyr::arrange(avg_log2FC) %>% head(15) %>% rownames()

#Figure 3 D
#pdf(file = "FinalFigures/Figure3_D_E.pdf", height = 14, width = 10)
#Top Markers that are cluster defining #icam1 is red #cd142 is green #Dpp4 is blue
dittoHeatmap(object = sc_Final_iWAT_Analysis,
             genes = c(YoungUp, OldUp), 
             cells.use = c(Dpp4_Cells, Icam1_Cells, Cd142_Cells), 
             order.by = c("Age"), 
             annot.by = c("Age", "Condition", "Clusters"),
             assay = "RNA",
             ...
             cluster_rows = F, 
             cluster_cols = F,
             labels_row = as.expression(lapply(c(YoungUp, OldUp), function(x) bquote(italic(.(x))))),
             heatmap.colors = HeatmapCols, fontsize_row = 17)
...
dittoHeatmap(object = sc_Final_iWAT_Analysis, 
             ...
             labels_row = as.expression(lapply(c(Dpp4_YTNvsOTN1, Dpp4_YTNvsOTN2, Dpp4_Y3DvsO3D1, Dpp4_Y3DvsO3D2, Dpp4_Y14DvsO14D1, Dpp4_Y14DvsO14D2), function(x) bquote(italic(.(x))))),
...
dittoHeatmap(object = sc_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F, fontsize_row = 25,
             labels_row = as.expression(lapply(c(Icam1_YTNvsOTN1, Icam1_YTNvsOTN2, Icam1_Y3DvsO3D1, Icam1_Y3DvsO3D2, Icam1_Y14DvsO14D1, Icam1_Y14DvsO14D2), function(x) bquote(italic(.(x))))),
             heatmap.colors = HeatmapCols)
...
dittoHeatmap(object = sc_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F, fontsize_row = 25,
             labels_row = as.expression(lapply(c(Cd142_YTNvsOTN1, Cd142_YTNvsOTN2, Cd142_Y3DvsO3D1, Cd142_Y3DvsO3D2, Cd142_Y14DvsO14D1, Cd142_Y14DvsO14D2), function(x) bquote(italic(.(x))))),
             heatmap.colors = HeatmapCols)
...
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis,
             ...
             labels_row = as.expression(lapply(c(Genes_Wh, Genes_High, Genes_Low, Genes_Be), function(x) bquote(italic(.(x))))),
...
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F,
             labels_row = as.expression(lapply(c(White_YTNvsOTN1, White_YTNvsOTN2, White_Y3DvsO3D1, White_Y3DvsO3D2), function(x) bquote(italic(.(x))))),
...
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F,
             labels_row = as.expression(lapply(c(HighYTNvsOTN1, HighYTNvsOTN2, HighY3DvsO3D1, HighY3DvsO3D2, HighY14DvsO14D1, HighY14DvsO14D2), function(x) bquote(italic(.(x))))),
...
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F,
             labels_row = as.expression(lapply(c(HighYTNvsOTN1, HighYTNvsOTN2), function(x) bquote(italic(.(x))))),
             heatmap.colors.max.scaled =  colorRampPalette(c("snow", "#1C9E03"))(25), fontsize_row = 25)
#Y3D vs O3D
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F,
             labels_row = as.expression(lapply(c(HighY3DvsO3D1, HighY3DvsO3D2), function(x) bquote(italic(.(x))))),
             heatmap.colors.max.scaled =  colorRampPalette(c("snow", "#1C9E03"))(25), fontsize_row = 25)
#Y14D vs O14D
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F,
             labels_row = as.expression(lapply(c(HighY14DvsO14D1, HighY14DvsO14D2), function(x) bquote(italic(.(x))))),
             heatmap.colors.max.scaled =  colorRampPalette(c("snow", "#1C9E03"))(25), fontsize_row = 25)


#Section 6 lipoegnic genes
Lipogenesis <- c("Fasn", "Acly", "Acaca", "Acsl1", "Acss2", "Mlxipl", "Me1", "Scd1", "Thrsp", "Elovl6", "Elovl3")
...
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F,
             labels_row = as.expression(lapply(c(Lipogenesis), function(x) bquote(italic(.(x))))),
             heatmap.colors.max.scaled =  colorRampPalette(c("snow", "#1C9E03"))(25), fontsize_row = 25)
...
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F,
             labels_row = as.expression(lapply(c(LowYTNvsOTN1, LowYTNvsOTN2, LowY3DvsO3D1, LowY3DvsO3D2), function(x) bquote(italic(.(x))))),
...
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             labels_row = as.expression(lapply(c(Beige_Y3DvsY14D1, Beige_Y3DvsY14D2,Beige_Y14DvsO14D1, Beige_Y14DvsO14D2), function(x) bquote(italic(.(x))))),
...
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             cluster_cols = F, 
             main = "Y14D vs O14D",
             labels_row = as.expression(lapply(c(Beige_Y14DvsO14D1, Beige_Y14DvsO14D2), function(x) bquote(italic(.(x))))),
             heatmap.colors.max.scaled =  colorRampPalette(c("snow", "blue"))(25), fontsize_row = 25)
...
dittoHeatmap(object = sn_AdipoReintegrated_Final_iWAT_Analysis, 
             ...
             cluster_rows = F, 
             cluster_cols = F,
             main = c("Y3DvsY14D LIPO, Y14DvsO14D LIPO"),
             labels_row = as.expression(lapply(c(Lipogenesis), function(x) bquote(italic(.(x))))),
             heatmap.colors.max.scaled =  colorRampPalette(c("snow", "blue"))(25), fontsize_row = 25)
...
```{r}
table(sn_AdipoReintegrated_Final_iWAT_Analysis$Clusters)

White <- subset(x = sn_AdipoReintegrated_Final_iWAT_Analysis, subset = Clusters == "White")
DNLlow <- subset(x = sn_AdipoReintegrated_Final_iWAT_Analysis, subset = Clusters == "DNL low")
DNLhigh <- subset(x = sn_AdipoReintegrated_Final_iWAT_Analysis, subset = Clusters == "DNL high")
Beige <- subset(x = sn_AdipoReintegrated_Final_iWAT_Analysis, subset = Clusters == "Beige")

white_Obj_TN <- subset(x = White,  subset = Condition == "TN")
white_Obj_TN_YNG <- subset(x = white_Obj_TN,  subset = Age == "Young")
white_Obj_TN_AGED <- subset(x = white_Obj_TN,  subset = Age == "Aged")

white_Obj_3D <- subset(x = White,  subset = Condition == "3 days")
white_Obj_3D_YNG <- subset(x = white_Obj_3D,  subset = Age == "Young")
white_Obj_3D_AGED <- subset(x = white_Obj_3D,  subset = Age == "Aged")

white_Obj_14D <- subset(x = White,  subset = Condition == "14 days")
white_Obj_14D_YNG <- subset(x = white_Obj_14D,  subset = Age == "Young")
white_Obj_14D_AGED <- subset(x = white_Obj_14D,  subset = Age == "Aged")

rm(White, white_Obj_TN, white_Obj_3D, white_Obj_14D)



DNLlow_Obj_TN <- subset(x = DNLlow,  subset = Condition == "TN")
DNLlow_Obj_TN_YNG <- subset(x = DNLlow_Obj_TN,  subset = Age == "Young")
DNLlow_Obj_TN_AGED <- subset(x = DNLlow_Obj_TN,  subset = Age == "Aged")

DNLlow_Obj_3D <- subset(x = DNLlow,  subset = Condition == "3 days")
DNLlow_Obj_3D_YNG <- subset(x = DNLlow_Obj_3D,  subset = Age == "Young")
DNLlow_Obj_3D_AGED <- subset(x = DNLlow_Obj_3D,  subset = Age == "Aged")

DNLlow_Obj_14D <- subset(x = DNLlow,  subset = Condition == "14 days")
DNLlow_Obj_14D_YNG <- subset(x = DNLlow_Obj_14D,  subset = Age == "Young")
DNLlow_Obj_14D_AGED <- subset(x = DNLlow_Obj_14D,  subset = Age == "Aged")

rm(DNLlow, DNLlow_Obj_TN, DNLlow_Obj_14D)



DNLhigh_Obj_TN <- subset(x = DNLhigh,  subset = Condition == "TN")
DNLhigh_Obj_TN_YNG <- subset(x = DNLhigh_Obj_TN,  subset = Age == "Young")
DNLhigh_Obj_TN_AGED <- subset(x = DNLhigh_Obj_TN,  subset = Age == "Aged")

DNLhigh_Obj_3D <- subset(x = DNLhigh,  subset = Condition == "3 days")
DNLhigh_Obj_3D_YNG <- subset(x = DNLhigh_Obj_3D,  subset = Age == "Young")
DNLhigh_Obj_3D_AGED <- subset(x = DNLhigh_Obj_3D,  subset = Age == "Aged")

DNLhigh_Obj_14D <- subset(x = DNLhigh,  subset = Condition == "14 days")
DNLhigh_Obj_14D_YNG <- subset(x = DNLhigh_Obj_14D,  subset = Age == "Young")
DNLhigh_Obj_14D_AGED <- subset(x = DNLhigh_Obj_14D,  subset = Age == "Aged")

rm(DNLhigh, DNLhigh_Obj_TN, DNLhigh_Obj_14D)


Beige_Obj_TN <- subset(x = Beige,  subset = Condition == "TN")
Beige_Obj_TN_YNG <- subset(x = Beige_Obj_TN,  subset = Age == "Young")
Beige_Obj_TN_AGED <- subset(x = Beige_Obj_TN,  subset = Age == "Aged")

Beige_Obj_3D <- subset(x = Beige,  subset = Condition == "3 days")
Beige_Obj_3D_YNG <- subset(x = Beige_Obj_3D,  subset = Age == "Young")
Beige_Obj_3D_AGED <- subset(x = Beige_Obj_3D,  subset = Age == "Aged")

Beige_Obj_14D <- subset(x = Beige,  subset = Condition == "14 days")
Beige_Obj_14D_YNG <- subset(x = Beige_Obj_14D,  subset = Age == "Young")
Beige_Obj_14D_AGED <- subset(x = Beige_Obj_14D,  subset = Age == "Aged")

rm(Beige, Beige_Obj_TN, Beige_Obj_3D, Beige_Obj_14D)

Lipogenesis <- c("Acly", "Fasn", "Acaca",  "Acss2", "Me1", "Scd1", "Mlxipl", "Elovl6", "Elovl3", "Thrsp", "Acsl1")

df_white_TN_YNG <- as.data.frame(AverageExpression(white_Obj_TN_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_white_TN_OLD <- as.data.frame(AverageExpression(white_Obj_TN_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_white_3D_YNG <- as.data.frame(AverageExpression(white_Obj_3D_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_white_3D_OLD <- as.data.frame(AverageExpression(white_Obj_3D_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_white_14D_YNG <- as.data.frame(AverageExpression(white_Obj_14D_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_white_14D_OLD <- as.data.frame(AverageExpression(white_Obj_14D_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_DNLlow_TN_YNG <- as.data.frame(AverageExpression(DNLlow_Obj_TN_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_DNLlow_TN_OLD <- as.data.frame(AverageExpression(DNLlow_Obj_TN_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_DNLlow_3D_YNG <- as.data.frame(AverageExpression(DNLlow_Obj_3D_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_DNLlow_3D_OLD <- as.data.frame(AverageExpression(DNLlow_Obj_3D_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_DNLlow_14D_YNG <- as.data.frame(AverageExpression(DNLlow_Obj_14D_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_DNLlow_14D_OLD <- as.data.frame(AverageExpression(DNLlow_Obj_14D_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_DNLhigh_TN_YNG <- as.data.frame(AverageExpression(DNLhigh_Obj_TN_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_DNLhigh_TN_OLD <- as.data.frame(AverageExpression(DNLhigh_Obj_TN_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_DNLhigh_3D_YNG <- as.data.frame(AverageExpression(DNLhigh_Obj_3D_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_DNLhigh_3D_OLD <- as.data.frame(AverageExpression(DNLhigh_Obj_3D_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_DNLhigh_14D_YNG <- as.data.frame(AverageExpression(DNLhigh_Obj_14D_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_DNLhigh_14D_OLD <- as.data.frame(AverageExpression(DNLhigh_Obj_14D_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

#df_Beige_TN_YNG <- as.data.frame(AverageExpression(Beige_Obj_TN_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
#df_Beige_TN_OLD <- as.data.frame(AverageExpression(Beige_Obj_TN_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_Beige_3D_YNG <- as.data.frame(AverageExpression(Beige_Obj_3D_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_Beige_3D_OLD <- as.data.frame(AverageExpression(Beige_Obj_3D_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

df_Beige_14D_YNG <- as.data.frame(AverageExpression(Beige_Obj_14D_YNG, features = Lipogenesis, group.by = "Species", assays = "RNA"))
df_Beige_14D_OLD <- as.data.frame(AverageExpression(Beige_Obj_14D_AGED, features = Lipogenesis, group.by = "Species", assays = "RNA"))

colnames(df_white_TN_YNG) <- "White YTN"
df_white_TN_YNG
colnames(df_white_TN_OLD) <- "White ATN"
df_white_TN_OLD
colnames(df_white_3D_YNG) <- "White Y3D"
df_white_3D_YNG
colnames(df_white_3D_OLD) <- "White A3D"
df_white_3D_OLD
colnames(df_white_14D_YNG) <- "White Y14D"
df_white_14D_YNG
colnames(df_white_14D_OLD) <- "White A14D"
df_white_14D_OLD

colnames(df_DNLlow_TN_YNG) <- "DNL-low YTN"
df_DNLlow_TN_YNG
colnames(df_DNLlow_TN_OLD) <- "DNL-low ATN"
df_DNLlow_TN_OLD
colnames(df_DNLlow_3D_YNG) <- "DNL-low Y3D"
df_DNLlow_3D_YNG
colnames(df_DNLlow_3D_OLD) <- "DNL-low A3D"
df_DNLlow_3D_OLD
colnames(df_DNLlow_14D_YNG) <- "DNL-low Y14D"
df_DNLlow_14D_YNG
colnames(df_DNLlow_14D_OLD) <- "DNL-low A14D"
df_DNLlow_14D_OLD

colnames(df_DNLhigh_TN_YNG) <- "DNL-high YTN"
df_DNLhigh_TN_YNG
colnames(df_DNLhigh_TN_OLD) <- "DNL-high ATN"
df_DNLhigh_TN_OLD
colnames(df_DNLhigh_3D_YNG) <- "DNL-high Y3D"
df_DNLhigh_TN_YNG
colnames(df_DNLhigh_3D_OLD) <- "DNL-high A3D"
df_DNLhigh_3D_OLD
colnames(df_DNLhigh_14D_YNG) <- "DNL-high Y14D"
df_DNLhigh_14D_YNG
colnames(df_DNLhigh_14D_OLD) <- "DNL-high A14D"
df_DNLhigh_14D_OLD

colnames(df_Beige_TN_YNG) <- "Beige YTN"
df_Beige_TN_YNG
colnames(df_Beige_TN_OLD) <- "Beige ATN"
df_Beige_TN_OLD
colnames(df_Beige_3D_YNG) <- "Beige Y3D"
df_Beige_3D_YNG
colnames(df_Beige_3D_OLD) <- "Beige A3D"
df_Beige_3D_OLD
colnames(df_Beige_14D_YNG) <- "Beige Y14D"
df_Beige_14D_YNG
colnames(df_Beige_14D_OLD) <- "Beige A14D"
df_Beige_14D_OLD


test <- data.frame(df_white_TN_YNG, df_white_3D_YNG, df_white_14D_YNG, 
                   df_white_TN_OLD, df_white_3D_OLD, df_white_14D_OLD,
                   
                   df_DNLlow_TN_YNG, df_DNLlow_3D_YNG, df_DNLlow_14D_YNG, 
                   df_DNLlow_TN_OLD, df_DNLlow_3D_OLD,  df_DNLlow_14D_OLD,
                   
                   df_DNLhigh_TN_YNG, df_DNLhigh_3D_YNG, df_DNLhigh_14D_YNG, 
                   df_DNLhigh_TN_OLD, df_DNLhigh_3D_OLD, df_DNLhigh_14D_OLD,
                   
                   df_Beige_3D_YNG, df_Beige_14D_YNG, df_Beige_14D_OLD)

test <- data.frame(df_DNLhigh_TN_YNG, df_DNLhigh_3D_YNG, df_DNLhigh_14D_YNG, 
                   df_DNLhigh_TN_OLD, df_DNLhigh_3D_OLD, df_DNLhigh_14D_OLD,
...
pheatmap(mat = test, 
  ...
  "RdYlBu")))(100),
         ...
         cluster_cols = F, 
         fontsize_row = 20, 
         labels_row = as.expression(lapply(c(rownames(test)), function(x) bquote(italic(.(x))))),
         fontsize_col = 15, angle_col = 45)

pheatmap(mat = test, 
         scale = "row", 
         display_numbers = F,
         gaps_col = c(6), cellwidth = 45, cellheight = 20,
         color = colorRampPalette(rev(brewer.pal(n = 7, name =
  "RdYlBu")))(100),
         cluster_rows = F, 
         cluster_cols = F, 
...
FeaturePlot(object = sn_AdipoReintegrated_Final_iWAT_Analysis, features = "Ucp1", order = T, split.by = "orig.ident", pt.size = 1.5)
...
VlnPlot(object = sn_AdipoReintegrated_Final_iWAT_Analysis, features = "Acly", pt.size = 0, split.by = "orig.ident", cols = SampSplitColors)

FeaturePlot(object = sn_AdipoReintegrated_Final_iWAT_Analysis, features = "Ucp1", order = T, pt.size = 1.5)
VlnPlot(object = sn_AdipoReintegrated_Final_iWAT_Analysis, features = "Ucp1", pt.size = 0, cols = colorlevels3)
VlnPlot(object = sn_AdipoReintegrated_Final_iWAT_Analysis, features = "Ucp1", pt.size = 0, split.by = "orig.ident", cols = SampSplitColors)

FeaturePlot(object = sn_AdipoReintegrated_Final_iWAT_Analysis, features = c("Ucp1", "Acly"), blend = T, cols = c( "blue", "#1C9E03"), split.by = "Age", pt.size = 1, order = T)
...
#Comparison betwen young and aged of the 14 day condition within all adipocytes
# Adipose_YoungvsAged <- FindMarkers(sn_AdipoReintegrated_Final_iWAT_Analysis@assays$RNA, cells.1 = colnames(sn_AdipoReintegrated_Final_iWAT_Analysis)[sn_AdipoReintegrated_Final_iWAT_Analysis$Age == "Young" & sn_AdipoReintegrated_Final_iWAT_Analysis$Condition == "14 days"], cells.2 = colnames(sn_AdipoReintegrated_Final_iWAT_Analysis)[sn_AdipoReintegrated_Final_iWAT_Analysis$Age == "Aged" & sn_AdipoReintegrated_Final_iWAT_Analysis$Condition == "14 days"], only.pos = T) %>% subset(p_val_adj < 0.01)
# Adipose_YoungvsAged$gene_name <- rownames(Adipose_YoungvsAged)
# df <- inner_join(Adipose_YoungvsAged, y = Tx, "gene_name")

#Checking just the old vs young comparison of all the groups in general
YvO_allclusters <- FindMarkers(sn_AdipoReintegrated_Final_iWAT_Analysis@assays$RNA,
                     cells.1 = colnames(sn_AdipoReintegrated_Final_iWAT_Analysis)[sn_AdipoReintegrated_Final_iWAT_Analysis$Age == "Young" &
                                                         sn_AdipoReintegrated_Final_iWAT_Analysis$Condition == "14 days"],
                     cells.2 = colnames(sn_AdipoReintegrated_Final_iWAT_Analysis)[sn_AdipoReintegrated_Final_iWAT_Analysis$Age == "Aged" &
                                                         sn_AdipoReintegrated_Final_iWAT_Analysis$Condition == "14 days"], only.pos = T) %>% subset(p_val_adj < 0.01) %>% rownames()


GO_YvO <- gost(query = list("Young vs Aged for 14 days condition" = YvO_allclusters),
     organism = "mmusculus", 
     ordered_query = T, significant = T, user_threshold = 0.05,
     exclude_iea = F,
     correction_method = "g_SCS", 
...
## BLAS/LAPACK: /opt/OpenBLAS/lib/libopenblas_skylakexp-r0.3.17.so
## 
## locale:
...
##  [1] forcats_0.5.2        stringr_1.5.0        dplyr_1.1.0.9000    
##  [4] purrr_1.0.1          readr_2.1.3          tidyr_1.3.0         
##  [7] tibble_3.1.8         tidyverse_1.3.2      RColorBrewer_1.1-3  
## [10] AnnotationDbi_1.56.2 IRanges_2.28.0       S4Vectors_0.32.4    
## [13] Biobase_2.54.0       edgeR_3.36.0         limma_3.50.3        
## [16] AnnotationHub_3.2.2  BiocFileCache_2.2.1  dbplyr_2.2.1        
## [19] BiocGenerics_0.40.0  tximport_1.22.0      gprofiler2_0.2.1    
## [22] pheatmap_1.0.12      dittoSeq_1.9.1       ggplot2_3.4.1       
## [25] scDblFinder_1.8.0    SeuratObject_4.1.3   Seurat_4.3.0.9001   
## 
## loaded via a namespace (and not attached):
##   [1] utf8_1.2.3                    spatstat.explore_3.0-6       
##   [3] reticulate_1.28               tidyselect_1.2.0             
##   [5] RSQLite_2.3.0                 htmlwidgets_1.6.1            
##   [7] grid_4.1.1                    BiocParallel_1.28.3          
##   [9] Rtsne_0.16                    munsell_0.5.0                
##  [11] ScaledMatrix_1.2.0            codetools_0.2-18             
##  [13] ica_1.0-3                     statmod_1.5.0                
##  [15] scran_1.22.1                  xgboost_1.7.3.1              
##  [17] future_1.31.0                 miniUI_0.1.1.1               
##  [19] withr_2.5.0                   spatstat.random_3.1-3        
##  [21] colorspace_2.1-0              progressr_0.13.0             
##  [23] filelock_1.0.2                knitr_1.42                   
##  [25] rstudioapi_0.14               SingleCellExperiment_1.16.0  
##  [27] ROCR_1.0-11                   tensor_1.5                   
##  [29] listenv_0.9.0                 MatrixGenerics_1.6.0         
##  [31] GenomeInfoDbData_1.2.7        polyclip_1.10-4              
##  [33] bit64_4.0.5                   parallelly_1.34.0            
##  [35] vctrs_0.5.2.9000              generics_0.1.3               
##  [37] xfun_0.37                     timechange_0.1.1             
##  [39] R6_2.5.1                      GenomeInfoDb_1.30.1          
##  [41] ggbeeswarm_0.7.1              rsvd_1.0.5                   
##  [43] locfit_1.5-9.7                bitops_1.0-7                 
##  [45] spatstat.utils_3.0-1          cachem_1.0.7                 
##  [47] DelayedArray_0.20.0           assertthat_0.2.1             
##  [49] promises_1.2.0.1              scales_1.2.1                 
##  [51] googlesheets4_1.0.1           beeswarm_0.4.0               
##  [53] gtable_0.3.1                  beachmat_2.10.0              
##  [55] globals_0.16.2                goftest_1.2-3                
##  [57] rlang_1.0.6.9000              splines_4.1.1                
##  [59] lazyeval_0.2.2                gargle_1.2.1                 
##  [61] broom_1.0.3                   spatstat.geom_3.0-6          
##  [63] modelr_0.1.10                 BiocManager_1.30.20          
##  [65] yaml_2.3.7                    reshape2_1.4.4               
##  [67] abind_1.4-7                   backports_1.4.1              
##  [69] httpuv_1.6.8                  tools_4.1.1                  
...
##  [79] deldir_1.0-6                  pbapply_1.7-0                
##  [81] viridis_0.6.2                 cowplot_1.1.1                
##  [83] zoo_1.8-11                    haven_2.5.1                  
##  [85] SummarizedExperiment_1.24.0   ggrepel_0.9.3                
##  [87] cluster_2.1.2                 fs_1.6.1                     
##  [89] magrittr_2.0.3                data.table_1.14.6            
##  [91] scattermore_0.8               reprex_2.0.2                 
##  [93] lmtest_0.9-40                 RANN_2.6.1                   
##  [95] googledrive_2.0.0             fitdistrplus_1.1-8           
##  [97] matrixStats_0.63.0            hms_1.1.2                    
##  [99] patchwork_1.1.2               mime_0.12                    
## [101] evaluate_0.20                 xtable_1.8-4                 
## [103] readxl_1.4.1                  gridExtra_2.3                
## [105] compiler_4.1.1                scater_1.22.0                
## [107] crayon_1.5.2                  KernSmooth_2.23-20           
## [109] htmltools_0.5.4               tzdb_0.3.0                   
## [111] later_1.3.0                   lubridate_1.9.0              
## [113] DBI_1.1.3                     rappdirs_0.3.3               
## [115] MASS_7.3-54                   Matrix_1.5-3                 
## [117] cli_3.6.0                     parallel_4.1.1               
## [119] metapod_1.2.0                 igraph_1.4.0                 
## [121] GenomicRanges_1.46.1          pkgconfig_2.0.3              
## [123] sp_1.6-0                      plotly_4.10.1                
## [125] scuttle_1.4.0                 spatstat.sparse_3.0-0        
## [127] xml2_1.3.3                    vipor_0.4.5                  
## [129] bslib_0.4.2                   dqrng_0.3.0                  
## [131] XVector_0.34.0                rvest_1.0.3                  
## [133] digest_0.6.31                 sctransform_0.3.5.9002       
## [135] RcppAnnoy_0.0.20              Biostrings_2.62.0            
## [137] spatstat.data_3.0-0           cellranger_1.1.0             
## [139] rmarkdown_2.20                leiden_0.4.3                 
## [141] uwot_0.1.14                   DelayedMatrixStats_1.16.0    
## [143] curl_5.0.0                    shiny_1.7.4                  
## [145] lifecycle_1.0.3               nlme_3.1-161                 
## [147] jsonlite_1.8.4                BiocNeighbors_1.12.0         
## [149] viridisLite_0.4.1             fansi_1.0.4                  
## [151] pillar_1.8.1                  lattice_0.20-45              
## [153] KEGGREST_1.34.0               fastmap_1.1.1                
## [155] httr_1.4.5                    survival_3.4-0               
## [157] interactiveDisplayBase_1.32.0 glue_1.6.2                   
## [159] png_0.1-8                     BiocVersion_3.14.0           
## [161] bit_4.0.5                     bluster_1.4.0                
## [163] stringi_1.7.12                sass_0.4.5                   
## [165] blob_1.2.3                    BiocSingular_1.10.0          
## [167] memoise_2.0.1                 irlba_2.3.5.1                
